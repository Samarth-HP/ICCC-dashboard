      ...
      <Row>
        ...
        <Col span={10}>
          ...
          >
            <Col>
              <div className="title">
                <b>View Detailed Dashboards</b>
              </div>
              <Button className="DetailsButton">Academic KPIs</Button>
              <Button className="DetailsButton">Administrative KPIs</Button>
              <Button className="DetailsButton">Review Meeting Scorecards</Button>
