...
const ReviewMeeting: FC = () => {
    ...
    const getDistrictAttendanceData = async (District: any, Month: any, _districtGeo?: any, _bounds?: any) => {
        setLoading(true);
        let data: any = [{}];
        const params: any = {
            district: "SIRMAUR",
    ...
    const getBlockAttendanceData = async (district: any, _districtGeo: any, _blockGeo: any, _bounds: any) => {
        setLoading(true);
        let data: any = [{}];
        const params: any = {
            ...
            getBoundGeoJson(function (bounds: any) {
                getDistrictGeoJson((districtResp: any) => {
                    getBlockGeoJson((blockRep: any) => {
                        ...
                        getDistrictAttendanceData("District", curMonth - 1, districtResp, bounds);
                    })
